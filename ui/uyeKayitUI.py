...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.combo_memberType.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.combo_sex.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.dateEdit_birthDate.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.le_beMemberDate.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.le_phoneNumber.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.le_sinif.setMinimumSize(QtCore.QSize(70, 30))
        ...
        self.le_sube.setMinimumSize(QtCore.QSize(70, 30))
        ...
        self.combo_memberStatus.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.btn_addImg = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.table_members = QtWidgets.QTableWidget(self.centralwidget)
        ...
        self.btn_openSampleExcel = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.btn_getFromExcel = QtWidgets.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Üye Kayıt"))
        self.label_16.setText(_translate("MainWindow", "Üyelik Tipi"))
        self.combo_memberType.setItemText(0, _translate("MainWindow", "Öğrenci"))
        self.combo_memberType.setItemText(1, _translate("MainWindow", "Personel"))
        self.label_7.setText(_translate("MainWindow", "TC Kimlik No"))
        self.label_8.setText(_translate("MainWindow", "Okul No"))
        self.label_9.setText(_translate("MainWindow", "Adı"))
        self.label_10.setText(_translate("MainWindow", "Soyadı"))
        self.label_11.setText(_translate("MainWindow", "Cinsiyet"))
        self.combo_sex.setItemText(0, _translate("MainWindow", "Kadın"))
        self.combo_sex.setItemText(1, _translate("MainWindow", "Erkek"))
        self.label_12.setText(_translate("MainWindow", "Doğum Tarihi"))
        self.dateEdit_birthDate.setDisplayFormat(_translate("MainWindow", "dd.MM.yyyy"))
        self.label_13.setText(_translate("MainWindow", "Üyelik Tarihi"))
        self.label_14.setText(_translate("MainWindow", "Telefon No"))
        self.label_15.setText(_translate("MainWindow", "Sınıf / Şube"))
        self.label_17.setText(_translate("MainWindow", " / "))
        self.label_18.setText(_translate("MainWindow", "Üye Durumu"))
        self.combo_memberStatus.setItemText(0, _translate("MainWindow", "Pasif"))
        self.combo_memberStatus.setItemText(1, _translate("MainWindow", "Aktif"))
        self.label_19.setText(_translate("MainWindow", "Üye Kartı"))
        self.checkBox_uyeKartiYazdirma.setText(_translate("MainWindow", "Yazdırma kuyruğuna ekle"))
        ...
        self.btn_openSampleExcel.setText(_translate("MainWindow", "Excel Dosyası"))
        self.btn_getFromExcel.setText(_translate("MainWindow", "Excel\'den Aktar"))
