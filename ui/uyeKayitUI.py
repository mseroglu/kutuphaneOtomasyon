...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setStyleSheet("QFrame { background-color: #a8ce43; border-radius: 5px }")
        ...
        self.btn_addImg = QtWidgets.QPushButton(self.tab)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ui\\../img/kitap-kurdu.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.table_members.setStyleSheet("QTableWidget {border: 5px solid green; border-radius: 5px }")
