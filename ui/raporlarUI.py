...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 211, 461))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(260, 20, 491, 461))
        self.groupBox_2.setObjectName("groupBox_2")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget.setGeometry(QtCore.QRect(230, 30, 231, 86))
        ...
        self.dateEdit_firstDate = QtWidgets.QDateEdit(self.layoutWidget)
        ...
        self.dateEdit_secondDate = QtWidgets.QDateEdit(self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 20, 181, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Teslim Zamanı Gelenler"))
        self.pushButton_2.setText(_translate("MainWindow", "Üye Kimlik Kartları"))
        self.pushButton_3.setText(_translate("MainWindow", "Tüm Barkodlar"))
        self.pushButton_8.setText(_translate("MainWindow", "Kuyruktaki Barkodlar"))
        self.pushButton_4.setText(_translate("MainWindow", "Üye Listesi"))
        self.pushButton_5.setText(_translate("MainWindow", "Eser Listesi (Barkod No Sıralı)"))
        self.pushButton_13.setText(_translate("MainWindow", "Eser Listesi (Eser Adı Sıralı)"))
        ...
        self.label.setText(_translate("MainWindow", "tarihleri arasında"))
